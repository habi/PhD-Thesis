...
\begingroup 
	...
	\begin{acronym}[WF-SRXTM]
		...
		\acro{tem}[TEM]{Transmission Electron Microscopy}: \acs{tem} is an electron microscopy technique whereby a beam of electrons is transmitted through an very thin specimen.
