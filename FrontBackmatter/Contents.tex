...
%   \newpage
	...
	\begin{acronym}[WF-SRXTM]
		...
		\acro{wf-srxtm}[WF-SRXTM]{wide field synchrotron radiation based x-ray tomographic microscopy}: The method to increase the field of view of tomographic imaging stations presented in chapter~\ref{ch:haberthuer2010}.
