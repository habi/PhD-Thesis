...
\begin{figure}[htb]%
	...
	\noindent\makebox[\textwidth]{%
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			...
			\draw node [darkgray] at (1198+\x,486+\y) {\huge$\circ$};
			...
			\draw node [cyan] at (1198,486) {\huge$\circ$};
...
\todo[inline]{Innerhalb der Standardabweichung dasselbe wie Lilian auf Paraffinschnitten (personal comm.); diese haben unterschiedliche Dicke, macht direkte Zahlen schwer vergleichbar}
