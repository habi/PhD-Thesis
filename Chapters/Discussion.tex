...
\begin{figure}
	\noindent\makebox[\textwidth]{%
		...
		\pgfmathsetlength{\imagescale}{\imagewidth/3996}%
		\def\x{2470}% scalebar-x at golden ratio of x=3996px
		\def\y{2326}% scalebar-y at 90% of height of y=2928px
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{img/discussion/SEM_crop_overlay}};
			% 572px = 0.1mm > 100px = 17um > 2860px = 500um, 572px = 100um
			%\draw[|-|,thick] (1347,2782) -- (1918,2774) node [sloped,midway,above] {\SI{0.1}{\milli\meter} (100px)};
			\draw[white,|-|,thick] (\x,\y) -- (\x+572,\y) node [midway, above] {\SI{100}{\micro\meter}};
	\end{tikzpicture}%
	}%
	...
	\todo[inline]{Johannes; die Regionen sind erstmals extrem grob eingezeichnet. Stimmen diese?}
	\label{fig:sem}%
\end{figure}
