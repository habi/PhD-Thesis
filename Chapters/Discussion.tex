...
\begin{figure}
	\noindent\makebox[\textwidth]{%
		...
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{img/SEM_crop_overlay}};
			...
			\draw[|-|,thick] (\x,\y) -- (\x+572,\y) node [midway, above] {\SI{100}{\micro\meter}};
	\end{tikzpicture}%
	}%
