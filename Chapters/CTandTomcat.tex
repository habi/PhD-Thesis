...
During the imaging process multiple transmission images---which are essentially single radiographic images---are obtained at several equidistant angles over a \unit{180}{\degree} or \unit{360}{\degree} rotation. These projections can be understood as pictures of the distribution of the attenuation of the x-rays inside the sample. Regions with high attenuation (\eg tissue) show up as dark pixels, regions with low attenuation (\eg airway lumens) show up as light pixels on the \acsu{ccd}-chip of the camera.
