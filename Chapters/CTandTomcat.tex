...
\begin{figure}%
	...
	\caption[Beamlines at the Swiss Light Source]{Beamlines at the \ac{sls}. Currently, 17 beamlines are in operation while 4 beamlines are under construction. Image from the \href{http://sls.web.psi.ch/view.php/beamlines/}{SLS Website}.}
	\label{fig:beamlines}
\end{figure}%
