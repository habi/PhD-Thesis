...
This chapter presents a short rundown on the history of \ac{ct}, the underlying principles of the interaction of radiation with matter. Subsequently, the theory behind tomographic reconstruction are presented and the machine that goes ``PING''---the beamline for \ac{tomcat} at the \ac{sls} in Villigen, Switzerland---where all experiments of this thesis have been performed is described.
...
\begin{figure}[h]%
	...
	\label{fig:Sin Rec}
	\todo[inline]{Is L-XXI-18, beamtime 2010a, Matthias Roth (?) really rat? }
\end{figure}
