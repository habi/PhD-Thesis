...
\begin{figure}%
	...
	\caption[Beamlines at the \acs{sls}]{Beamlines at the \ac{sls}. Currently, 17 beamlines are in operation while 4 beamlines are under construction. Image from the \href{http://sls.web.psi.ch/view.php/beamlines/}{\ac{sls} Website}~\cite{wwwsls}.}
	\label{fig:beamlines}
\end{figure}%
