...
\subsection{Scattering}\todo{MOAR!}
\subsubsection{Coherent scattering}\todo{MOAR!}
\subsubsection{Incoherent scattering}\todo{MOAR!}

\begin{figure}
	\missingfigure{Interaction Percentage -> Mohammed Tabelle}
