...
\section{Main goal of the Thesis}\todo{REFORMULATE LESS PESSIMISTIC}
...
Another project was focused on the interaction of particles in the lung tissue. To have a basis for the simulation of the deposition of sub-micron sized particles in the gas-exchange region of the lung, we sought an imaging method to analyze both the exact localization of such particles in the three-dimensional structure of the lung and additionally exactly analyze their properties in relation to the lung tissue. This goal was reached by using a multimodal approach combining images of \ac{srxtm} and \ac{tem} datasets.
