...
In parallel to alveolarization, the interalveolar septa and their capillary networks are remodeled during microvascular maturation in order to optimize gas exchange (personal communication with Prof.\ Dr.\ Johannes C.\ Schittny). At this point lung development is considered to be finished and normal growth of the organ follows\graffito{The time point of birth differs between mammals, relative to the state of lung development. In humans, birth happens at the beginning of the alveolarization stage.}.
...
\section{The need for Tomography}
...
% \renewcommand\bibname{Bibliography | The mammalian lung}%
