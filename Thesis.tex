...
%\usepackage[square,numbers,sort&compress,sectionbib]{natbib}\usepackage{chapterbib}% Chapter Bibliography
...
\newcommand{\myTitle}{A close look deep into the lung\xspace}
\newcommand{\myDegree}{High resolution tomographic imaging of the alveolar region of the mammalian lung\xspace}
