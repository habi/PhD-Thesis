...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pgfplotsset{width=\linewidth,height=.5\linewidth}
		...
		\begin{axis}[xbar stacked,%
			...
			\addplot [fill=orange]	coordinates {(9,6*\step)};
			\addplot [transparent]	coordinates {(-4,6.5*\step)};
			...
			\node[coordinate, pin=right:{Microvascular maturation (P14--$\sim$P21)}] at (axis cs:44,0.3) {};
			\node[coordinate, pin=left:{Lung Growth ($\sim$P21--adulthood)}] at (axis cs:40,0.35) {};
		\end{axis}
	\end{tikzpicture}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\end{document}